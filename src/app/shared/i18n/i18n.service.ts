...
const translations: Record<'en' | 'ru', Record<string, string>> = {
  en: {
    ...
    'services.card3.title': 'Auto Transportation',
    'services.card3.desc': 'Regional fleet deliveries with flexible scheduling.',
    'services.card3.more': 'Dedicated dispatch monitors routes and adjusts to weather or border delays.',
  ...
  ru: {
    ...
    'services.card3.title': 'Автоперевозки',
    'services.card3.desc': 'Региональные доставки автопарком с гибким графиком.',
    'services.card3.more': 'Диспетчерская команда следит за маршрутом и корректирует график при задержках.',
