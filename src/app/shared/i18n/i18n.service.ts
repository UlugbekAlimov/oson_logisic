...
const translations: Record<'en' | 'ru', Record<string, string>> = {
  ...
  ru: {
    ...
    'hero.title': 'Логистика для вашего груза',
    'hero.subtitle':
      'Оптимизируем маршруты, контролируем безопасность и соблюдаем сроки — для стабильной работы вашего бизнеса.',
    ...
    'services.title': 'Комплексные услуги доставки и хранения',
    'services.subtitle':
